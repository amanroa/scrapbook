...
const messages = [
  ...
  //page 4
  "We went to the beach! It was so much fun, but the water was incredibly cold. On the drive back it rained really hard, so from then on I will always drive Aashni around",
  //page 5
  "Message for image 4",
  //page 6
  "Message for image 5",
